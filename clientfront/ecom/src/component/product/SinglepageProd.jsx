...
console.log(products);
  ...
  const product = products.find((product) => product._id === id);
   const relatedprod = products.filter((related)=>related.category===product.category)
//  console.log(relatedprod);
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <p className="text-light">
            Category : <span className="badge badge-info">{product.category}</span>
          </p>
          ...
          {/* Product Quantity */}
          <div className="mb-4">
            <label htmlFor="quantity" className="form-label text-light">Quantity</label>
            <input
              type="number"
              id="quantity"
  ...
  <button className="btn btn-success btn-lg m-3">Buy Now</button>
      ...
      {/* --------------------------related Products--------------  */}
      <div className="mt-5">
        <h4 className="text-light align-items-center text-center display-4  fw-bold ">Related Products</h4>
        <p className="text-light">
